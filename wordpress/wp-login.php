...
<body class="login">
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', 'http://itbsocial.net/'); ?>" title="<?php echo apply_filters('login_headertitle', esc_attr__('ITB Social')); ?>"><?php bloginfo('name'); ?></a></h1>
<?php   } else { ?>
